...
export function Register(): React.ReactElement {
  ...
  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    if (state === RegisterFlow.NO_INFO_FILLED)
    ...
    <KontinumRegisterDiv>
      ...
      <ContainerRegister>
        <MultiSubContainer padding={"50px"}>
          ...
          <KontinumP opacity={0.6} margin={"0px 0px 20px 0px"}>
            Create your account to browse the site.
          </KontinumP>
        </MultiSubContainer>
          ...
          {state === RegisterFlow.NO_INFO_FILLED && (
            <>
              ...
              <MultiSubContainer padding={"40px"}>
                <KontinumSignature opacity={0.6}>
                  Copyright by Kontinum 2024. All Rights Reserved.
                </KontinumSignature>
              </MultiSubContainer>
            </>
          )}{" "}
